...
if __name__ == '__main__':
    ...
    for commit_id in cm:
        count+=1
        print('Embedding Grap with commit: {}, process: {}/{}'.format(commit_id, count, len(list(cm))))
    # for commit_id in cm:
        try:
...
# python3 Main_Graph_Embedding_AST.py --node_graph_dir="Data/Graph/VFC/node" --edge_graph_dir="Data/Graph/VFC/edge" --label=1 --embedding_graph_dir="Data/Embedding_119"
# python3 Main_Graph_Embedding_AST.py --node_graph_dir="Data/Graph/VNFC/node" --edge_graph_dir="Data/Graph/VNFC/edge" --label=0 --embedding_graph_dir="Data/Embedding_119"  